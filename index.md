...
Here is a link to my Github profile: https://github.com/RS-1122/RS-1122.github.io
...
*Lab 6 part 2 
  ...
  I thought this lab was interesting for me because I got to make a code for the game blackjack. I had to use if and if-else statements to help determine the score and whether the score is greater or less than 21. For me, the most challenging part of this lab was being able to determine the correct format in putting in the if statement for the card_name values but once I was able to determine the format for it, I was able to figure out the rest of the other if-statements so that I am able to correctly return the total score when the program is run. 
